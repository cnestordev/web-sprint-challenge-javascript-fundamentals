...
zooAnimals.forEach(animal => {
  let phrase = `Name: ${animal.animal_name}, Scientific: ${animal.scientific_name}.`;
  displayNames.push(phrase);
});
...
*/
let populationTotal = zooAnimals.reduce((count, animal) => (count += animal.population), 0);
